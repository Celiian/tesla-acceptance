Feature: Evenements tesla
  Scenario:Accéder a la page et voir des évenements
    ...
    Scenario: S'inscrire pour recevoir les news
      Given Je suis sur la page "https://www.tesla.com/fr_fr/events"
      Then Un formulaire d'inscription est disponible avec les champs "Prénom" "Nom" "E-mail" "Téléphone" "Région" "Code postal" "Recevoir les News Tesla" et un bouton d'envoi "Suivant"
      Then Lorsque je remplis le formulaire sans l'email et que je le valide un message rouge apparait sous le champ de l'email indiquant "obligatoire"
